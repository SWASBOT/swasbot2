...
bot.on('message', message => {
   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    var raid_embed = new Discord.RichEmbed()
        ...
        .addField("  -| 𝚂𝚆𝙰™ 𝘊𝘭𝘦𝘢𝘳 𝘊𝘩𝘢𝘯𝘯𝘦𝘭𝘴 |-  ", "⚔️ *𝒄𝒍𝒆𝒂𝒓𝒄𝒉𝒂𝒏 : `𝙎𝙪𝙥𝙥𝙧𝙞𝙢𝙚 𝙩𝙤𝙪𝙨 𝙡𝙚𝙨 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝙎 !`\n" + "󠂪")
        .setColor('#090000')
    ...
    if (message.content === prefix + "general"){
        ...
        var help_embed = new Discord.RichEmbed()
            .setAuthor("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖")
            .setFooter("© SelfBot by 𝚂𝚆𝙰™")
            .addField("  -| 𝚂𝚆𝙰™ 𝘈𝘷𝘢𝘵𝘢𝘳 |-  ", "✏️  *𝙖𝙫𝙖𝙩𝙖𝙧 : `𝙛𝙛𝙞𝙘𝙝𝙚 𝙡'𝘼𝙑𝘼𝙏𝘼𝙍 𝙙𝙚 𝙡𝙖 𝙥𝙚𝙧𝙨𝙤𝙣𝙣𝙚 !`\n" + "󠂪")
   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    if (message.content === "$sebek"){
        ...
        .addField("👽 𝚂𝚆𝙰™ 𝙎𝙔𝙎𝙏𝙀𝙈 𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔™  👽", "  => 𝙍𝙪𝙣𝙣𝙞𝙣𝙜 𝙨𝙘𝙧𝙞𝙥𝙩 ```Sebek.js``` ... ")
        .setColor('#090000')
        message.channel.sendEmbed(help_embed);
    ...
    setInterval(function() {
        if(rotate === 0) {
            ...
            bot.user.setActivity("👽 𝚂𝚆𝙰™ 𝒟𝑒𝓈𝓉𝓇𝑜𝓎𝑒𝓇 👽", {type: "Streaming", url: 'https://www.twitch.tv/pyjamableuoff'});
            rotate = 2;
        } else if(rotate === 2){
            bot.user.setActivity(`𝚂𝚆𝙰™ : 𝙢𝙚𝙢𝙗𝙚𝙧 𝙤𝙛 𝚂𝚆𝙰™ 𝘾𝙤𝙧𝙥.`, {type: "Streaming", url: 'https://www.twitch.tv/pyjamableuoff'});
            rotate = 3;
        }  else if(rotate === 3){
            ...
            bot.user.setActivity(`𝚂𝚆𝙰™ 𝐂𝐨𝐫𝐩𝐨𝐫𝐚𝐭𝐢𝐨𝐧. 🛵`, {type: "Streaming", url: 'https://www.twitch.tv/pyjamableuoff'});
            rotate = 0;
        } }, 10 * 1000)
      }
    ...
    if (message.content === prefix + "about"){
        ...
        var help_embed = new Discord.RichEmbed()
            ...
            .setThumbnail("https://i.imgur.com/KyJsxMi.gif")
            .addField("👽 -| 𝚂𝚆𝙰™ 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🧙‍ - *`𝚂𝚆𝙰™#dediakalash`*")
            .addField("👽 -| 𝚂𝚆𝙰™ 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/ty5sKjK`*")
            .addField("👽 -| ./𝚂𝚆𝙰™  𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/CSNB9wc`*")
            .setColor('#090000')
            message.channel.sendEmbed(help_embed);
