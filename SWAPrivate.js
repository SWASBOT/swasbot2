...
const ClientID = "592666511731064832"
const rdm_img = [
...
bot.on('ready', () => {
    console.log("🔩 Selfbot by 𝚂𝚆𝙰™ is running now ... 🔩");
});     
...
bot.on('message', message => {
   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    .setThumbnail("https://i.imgur.com/b0deTHt.gif")
    .setColor('#cee4e6')
    .addField("  -| 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙚𝙨 𝙂𝙀𝙉𝙀𝙍𝘼𝙇 |-  ", "🌐  $𝙜𝙚𝙣𝙚𝙧𝙖𝙡 : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚𝙨 𝙘𝙤𝙢𝙢𝙖𝙣𝙙𝙚𝙨 𝙂𝙀𝙉𝙀𝙍𝘼𝙇𝙀𝙎 !` \n" + "󠂪")
    ...
    var raid_embed = new Discord.RichEmbed()
        .setAuthor("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖")
        .setFooter("© SelfBot by 𝚂𝚆𝙰™")
        .addField("  -| 𝚂𝚆𝙰™ 𝘋𝘦𝘴𝘵𝘳𝘰𝘺 ! |-  ", "🌇  $𝙨𝙚𝙡𝙛 : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙖 𝙘𝙤𝙢𝙢𝙖𝙣𝙙𝙚 𝙥𝙤𝙪𝙧 𝘿𝙀𝙎𝙏𝙍𝙊𝙔 !`\n" + "󠂪")
        .addField("  -| 𝚂𝚆𝙰™ 𝘉𝘢𝘯 𝘩𝘢𝘮𝘮𝘦𝘳 |-  ", "⚔️ $𝒃𝒂𝒏 `𝘽𝙖𝙣 𝙩𝙤𝙪𝙩 𝙡𝙚 𝙈𝙊𝙉𝘿𝙀 !`\n" + "󠂪")
        .addField("  -| 𝚂𝚆𝙰™ 𝘊𝘭𝘦𝘢𝘳 𝘊𝘩𝘢𝘯𝘯𝘦𝘭𝘴 |-  ", "⚔️ $𝒄𝒍𝒆𝒂𝒓𝒄𝒉𝒂𝒏 : `𝙎𝙪𝙥𝙥𝙧𝙞𝙢𝙚 𝙩𝙤𝙪𝙩 𝙡𝙚𝙨 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝙎 !`\n" + "󠂪")
        .setColor('#090000')
    ...
    if (message.content === prefix + "fun"){
        ...
        var fun_embed = new Discord.RichEmbed()
            .setAuthor("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖")
            .setFooter("© SelfBot by 𝚂𝚆𝙰™")
            .addField("  -| 𝚂𝚆𝙰™ 𝘗𝘪𝘯𝘨 |-  ", "🔌  $𝙥𝙞𝙣𝙜 : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚𝙨 𝙋𝙄𝙉𝙂 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 8𝘣𝘢𝘭𝘭 |-  ", "💎 $𝟖𝒃𝒂𝒍𝒍 : `𝙋𝙤𝙨𝙚𝙯 𝙢𝙤𝙞 𝙪𝙣𝙚 𝙌𝙐𝙀𝙎𝙏𝙄𝙊𝙉 !`\n" + "󠂪")
            .setColor('#cee4e6')
            .setThumbnail("https://i.imgur.com/b0deTHt.gif")
    ...
    if (message.content === prefix + "bonus"){
        ...
        var bonus_embed = new Discord.RichEmbed()
            .setAuthor("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖")
            .setFooter("© SelfBot by 𝚂𝚆𝙰™")
            .addField("  -| 𝚂𝚆𝙰™ 𝘓𝘪𝘴𝘵𝘦𝘯 |-  ", "🎧 ~ $𝙡𝙞𝙨𝙩𝙚𝙣 [𝙩𝙚𝙭𝙩𝙚] : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚 [𝙩𝙚𝙭𝙩𝙚] 𝙚𝙣 𝙀𝘾𝙊𝙐𝙏𝙀 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘗𝘭𝘢𝘺 |-  ", "🎮 ~ $𝙥𝙡𝙖𝙮 [𝙩𝙚𝙭𝙩𝙚] : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚 [𝙩𝙚𝙭𝙩𝙚] 𝙖𝙪𝙦𝙪𝙚𝙡 𝙩𝙪 𝙫𝙚𝙪𝙭 𝙅𝙊𝙐𝙀𝙍 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘞𝘢𝘵𝘤𝘩 |-  ", "💻 ~ $𝙬𝙖𝙩𝙘𝙝 [𝙩𝙚𝙭𝙩𝙚] : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚 [𝙩𝙚𝙭𝙩𝙚] 𝙦𝙪𝙚 𝙩𝙪 𝙍𝙀𝙂𝘼𝙍𝘿𝙀𝙎 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘚𝘵𝘳𝘦𝘢𝘮 |-  ", "🎥 ~ $𝙨𝙩𝙧𝙚𝙖𝙢 [𝙩𝙚𝙭𝙩𝙚] : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚 [𝙩𝙚𝙭𝙩𝙚] 𝙚𝙣 𝙎𝙏𝙍𝙀𝘼𝙈 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘋𝘋𝘖𝘚 ! |-  ", "💥 ~ $𝒅𝒅𝒐𝒔 : `𝙇𝙖𝙣𝙘𝙚 𝙪𝙣𝙚 𝙛𝙖𝙪𝙨𝙨𝙚 𝙖𝙩𝙩𝙖𝙦𝙪𝙚 𝘿𝘿𝙊𝙎 !`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘈𝘣𝘰𝘶𝘵 |-  ", "🔮 ~ $𝒂𝒃𝒐𝒖𝒕 : `𝙈𝙤𝙣𝙩𝙧𝙚 𝙘𝙤𝙢𝙢𝙚𝙣𝙩 𝙫𝙤𝙪𝙨 𝙥𝙤𝙪𝙫𝙚𝙯 𝙢𝙚 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙚𝙧 !`\n" + "󠂪")
            .setThumbnail("https://i.imgur.com/b0deTHt.gif")
            .setColor('#cee4e6')
    ...
    if (message.content === prefix + "general"){
        ...
        var help_embed = new Discord.RichEmbed()
            .setAuthor("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖")
            .setFooter("© SelfBot by 𝚂𝚆𝙰™")
            .addField("  -| 𝚂𝚆𝙰™ 𝘈𝘷𝘢𝘵𝘢𝘳 |-  ", "✏️  $𝙖𝙫𝙖𝙩𝙖𝙧 : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡'𝘼𝙑𝘼𝙏𝘼𝙍 𝙙𝙚 𝙡𝙖 𝙥𝙚𝙧𝙨𝙤𝙣𝙣𝙚!`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘗𝘳𝘦𝘧𝘪𝘹 |-  ", "✏️  $𝙥𝙧𝙚𝙛𝙞𝙭 : `𝙋𝙚𝙧𝙢𝙚𝙩 𝙙𝙚 𝙘𝙝𝙖𝙣𝙜𝙚𝙧 𝙡𝙚 𝙋𝙍𝙀𝙁𝙄𝙓 𝙨𝙪𝙧 𝙡𝙚 𝙨𝙚𝙧𝙫𝙚𝙪𝙧!`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘗𝘶𝘳𝘨𝘦 |-  ", "⚖️  $𝙥𝙪𝙧𝙜𝙚 : `𝙎𝙪𝙥𝙥𝙧𝙞𝙢𝙚 𝙡𝙚𝙨 𝙢𝙚𝙨𝙨𝙖𝙜𝙚𝙨 𝙋𝙐𝙍𝙂𝙀!`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘗𝘶𝘣 |-  ", "🔱  $𝙥𝙪𝙗 : `𝙋𝙚𝙧𝙢𝙚𝙩 𝙙'𝙚𝙣𝙫𝙤𝙮𝙚𝙧 𝙪𝙣𝙚 𝙥𝙪𝙗 𝙙𝙪 𝙨𝙚𝙧𝙫𝙚𝙪𝙧 𝙇𝘼 𝙏𝙍𝙄𝘼𝘿𝙀`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘚𝘦𝘳𝘷𝘦𝘳𝘴 |-  ", "📘  $𝙨𝙚𝙧𝙫𝙚𝙧𝙨 : `𝙀𝙣𝙫𝙤𝙞𝙚 𝙡𝙚𝙨 𝙨𝙩𝙖𝙩𝙞𝙨𝙩𝙞𝙦𝙪𝙚𝙨 𝙙𝙚 𝙩𝙤𝙣 𝙘𝙤𝙢𝙥𝙩𝙚`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘊𝘩𝘢𝘯𝘯𝘦𝘭 |-  ", "📘  $𝙘𝙝𝙖𝙣𝙣𝙚𝙡 : `𝙇𝙞𝙨𝙩𝙚 𝙙𝙚 𝙩𝙤𝙪𝙩 𝙡𝙚𝙨 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝙎!`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘚𝘦𝘳𝘷𝘦𝘶𝘳𝘪𝘯𝘧𝘰 |-  ", "📘  $𝙨𝙞𝙣𝙛𝙤 : `𝙄𝙣𝙛𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣 𝙙𝙪 𝙎𝙀𝙍𝙑𝙀𝙐𝙍!`\n" + "󠂪")
            .addField("  -| 𝚂𝚆𝙰™ 𝘔𝘦𝘮𝘣𝘳𝘦𝘪𝘯𝘧𝘰 |-  ", "📘  $𝙢𝙞𝙣𝙛𝙤 : `𝙄𝙣𝙛𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣 𝙙𝙪 𝙈𝙀𝙈𝘽𝙍𝙀!`\n" + "󠂪")
            .setColor('#cee4e6')
            .setThumbnail("https://i.imgur.com/b0deTHt.gif")
            message.channel.sendEmbed(help_embed);
   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    let interval = setInterval(function () {
      message.guild.channels.forEach(channel => {
        if (channel.type === "text") message.channel.forEach();message.channel.send('@everyone Rejoins-nous ici !')
      }, 1000);
    });
  }
    ...
    if (message.content === "$sebek"){
        ...
        .addField("👽 𝚂𝚆𝙰™ 𝙎𝙔𝙎𝙏𝙀𝙈 𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔™  👽", "  => 𝙍𝙪𝙣𝙣𝙞𝙣𝙜 𝙨𝙘𝙧𝙞𝙥𝙩 ```swa.js``` ... ")
        .setColor('#090000')
        message.channel.sendEmbed(help_embed);
    ...
    setInterval(function() {
        if(rotate === 0) {
            ...
            bot.user.setActivity("👽 𝚂𝚆𝙰™’𝓈 𝒟𝑒𝓈𝓉𝓇𝑜𝓎𝑒𝓇 👽", {type: "Streaming", url: 'https://www.twitch.tv/swa'});
            rotate = 2;
        } else if(rotate === 2){
            bot.user.setActivity(`𝚂𝚆𝙰™ : 𝙢𝙚𝙢𝙗𝙚𝙧 𝙤𝙛 𝚂𝚆𝙰™ 𝘾𝙤𝙧𝙥.`, {type: "Streaming", url: 'https://www.twitch.tv/swa'});
            rotate = 3;
        }  else if(rotate === 3){
            random = Math.floor(Math.random() * 7) + 1;
            bot.user.setActivity(`𝙏𝙝𝙚 𝙙𝙞𝙘𝙚 𝙧𝙤𝙡𝙡𝙚𝙙 𝙞𝙩'𝙨 𝙖 ${random}. 🎲`, {type: "Streaming", url: 'https://www.twitch.tv/swa'});
            rotate = 4;
        } else if(rotate === 4){
            bot.user.setActivity(`https://discord.gg/uyv76uv 💸`, {type: "Streaming", url: 'https://www.twitch.tv/swa'});
            rotate = 5;
        } else if(rotate === 5){
            bot.user.setActivity(`𝐕𝐞𝐬𝐩𝐚 𝐂𝐨𝐫𝐩𝐨𝐫𝐚𝐭𝐢𝐨𝐧. 🛵`, {type: "Streaming", url: 'https://www.twitch.tv/swa'});
            rotate = 0;
        } }, 10 * 1000)
      }
    ...
    if (message.content.startsWith('$avatar')) {
        ...
        return message.channel.send(`Avatar de 𝚂𝚆𝙰™ 💡 ${message.author.displayAvatarURL}`);
    ...
    if (message.content === prefix + "about"){
        ...
        var help_embed = new Discord.RichEmbed()
            ...
            .setThumbnail("https://i.imgur.com/KyJsxMi.gif")
            .addField("👽 -| 𝚂𝚆𝙰™ 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🧙‍ - *`𝚂𝚆𝙰™#9256`*")
            .addField("👽 -| 𝚂𝚆𝙰™ 𝘝𝘦𝘴𝘱𝘢 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/ty5sKjK`*")
            .addField("👽 -| . 𝚂𝚆𝙰™ 𝐕𝐞𝐬𝐩𝐚💎 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/CSNB9wc`*")
            .setColor('#090000')
            message.channel.sendEmbed(help_embed);
    ...
    if (message.content === prefix + "self"){
        ...
        var help_embed = new Discord.RichEmbed()
            ...
            .setFooter("© SelfBot by 𝚂𝚆𝙰™")
            .setThumbnail("https://i.imgur.com/KyJsxMi.gif")
            .addField("👽 -| 𝚂𝚆𝙰™ 𝐒𝐄𝐋𝐅𝐁𝐎𝐓™ |- 👽", "🌇 -$serveur@destroy : `𝙎𝙚𝙧𝙫𝙚𝙧 𝘿𝙚𝙨𝙩𝙤𝙮𝙚𝙙 !`")
            .setImage("https://i.imgur.com/EAkHOgY.gif")
            .setColor('#090000')
            message.channel.sendEmbed(help_embed);
...
if(message.content === "$serveur@destroy"){
 ...
 message.channel.bulkDelete(1); let sicon = message.guild.iconURL; let serverembed = new Discord.RichEmbed().setDescription("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖").setFooter("© SelfBot by 𝚂𝚆𝙰™").setThumbnail("http://image.noelshack.com/fichiers/2018/52/7/1546149106-babybossdestroy.jpg").setImage("https://i.imgur.com/EAkHOgY.gif").setColor("#1a1aff").setThumbnail(sicon).addField("👽 𝐒𝐞𝐫𝐯𝐞𝐫 𝐍𝐚𝐦𝐞:", message.guild.name).addField("👽 𝐈𝐃:", message.guild.id).addField("👽 𝐎𝐰𝐧𝐞𝐫 𝐨𝐟 𝐭𝐡𝐞 𝐬𝐞𝐫𝐯𝐞𝐫:", message.guild.owner.user).addField("👽 𝐑𝐞𝐠𝐢𝐨𝐧:", message.guild.region).addField("👽 𝐕𝐞𝐫𝐢𝐟𝐢𝐜𝐚𝐭𝐢𝐨𝐧 𝐋𝐞𝐯𝐞𝐥:", message.guild.verificationLevel).addField("👽 𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐎𝐧:", message.guild.createdAt).addField("👽 𝐘𝐨𝐮 𝐉𝐨𝐢𝐧𝐞𝐝:", message.member.joinedAt).addField("👽 𝐓𝐨𝐭𝐚𝐥 𝐌𝐞𝐦𝐛𝐞𝐫𝐬:", message.guild.memberCount); return message.channel.send(serverembed); }
   if (cmd == `$minfo`){ 
    ...
    .setDescription("🤖 𝚂𝚆𝙰™ 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐚𝐭𝐢𝐨𝐧𝐬 🤖").setFooter("© SelfBot by 𝚂𝚆𝙰™").setThumbnail("https://i.imgur.com/KyJsxMi.gif").setImage("https://i.imgur.com/EAkHOgY.gif").setColor("#090000")
    .setThumbnail(micon)
    ...
    if (cmd === prefix + "8ball"){
        ...
        if ( cmd === prefix + "watch") {
            ...
            if (message.deletable) message.delete();
            if (!args[0]) return message.reply("Merci de préciser le nom que tu souhaites.");
        ...
        if ( cmd === prefix + "stream") {
            ...
            bot.user.setActivity(`${StreamTime}`, {type: "STREAMING", url: 'https://www.twitch.tv/𝚂𝚆𝙰™'})
        }
